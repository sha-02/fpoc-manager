...
FGT_A = FortiGate(name_fpoc='SDW-1001F-A', alias='SDW-1001F-A', password='Fortinet123#',
    mgmt=Interface('mgmt', 0, '10.210.0.59/23'),
    lan=Interface('port6', vlanid=0, speed='1000auto'),
   )
FGT_B = FortiGate(name_fpoc='SDW-1001F-B', alias='SDW-1001F-B', password='Fortinet123#',
...
FGT_A = FortiGate(name_fpoc='SDW-3301E-A', alias='SDW-3301E-A', password='Fortinet123#',
    mgmt=Interface('mgmt1', 0, '10.210.0.63/23'),
    lan=Interface('port6', vlanid=0, speed='auto'),
    )
FGT_B = FortiGate(name_fpoc='SDW-3301E-B', alias='SDW-3301E-B', password='Fortinet123#',
...
FGT_A = FortiGate(name_fpoc='SDW-101F-A', alias='SDW-101F-A', password='Fortinet123#',
    mgmt=Interface('mgmt', 0, '10.210.0.23/23'),
    lan=Interface('port4', vlanid=0, speed='auto'),
    )
FGT_B = FortiGate(name_fpoc='SDW-101F-B', alias='SDW-101F-B', password='Fortinet123#',
...
FGT_A = FortiGate(name_fpoc='SDW-50G-A', alias='SDW-50G-A', password='Fortinet123#',
    mgmt=Interface('lan2', 0, '10.210.0.250/23'),
    lan=Interface('lan', vlanid=0, speed=None), # speed None since 'lan' is in a virtual-switch
    )
FGT_B = FortiGate(name_fpoc='SDW-50G-B', alias='SDW-50G-B', password='Fortinet123#',
