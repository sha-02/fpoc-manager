...
urlpatterns = [
    ...
    # Class instance (StudioVPN()) must not be created here because it is created as a default argument of the function
    ...
    # path('poweron/', fpoc.views.poweron, {'Class_PoC': StudioVPN}, name='poweron'),
    # path('upgrade/', fpoc.views.upgrade, {'Class_PoC': StudioVPN}, name='upgrade'),
    # path('bootstrap/', fpoc.views.bootstrap, {'Class_PoC': StudioVPN}, name='bootstrap'),
