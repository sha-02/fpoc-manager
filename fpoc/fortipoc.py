...
class FortiPoC:
    ...
    mgmt_fpoc = '172.16.31.254/24'  # mgmt IP@ of FortiPoC in its OOB management subnet
...
class FortiPoCFoundation1(FortiPoC):
    devices = {
        ...
        'FGT-A_sec': FortiGate(offset=1, mgmt_ip='172.16.31.13/24',
                               wan=WAN(
                                   inet=WanSettings('port1', 0, '198.51.100'),
                                   inet1=WanSettings('port1', 11, '100.64.11'),
                                   inet2=WanSettings('port1', 12, '100.64.12'),
        ...
        'FGT-B': FortiGate(offset=2, mgmt_ip='172.16.31.2/24',
                           wan=WAN(
        ...
        'FGT-B_sec': FortiGate(offset=3, mgmt_ip='172.16.31.14/24',
                               wan=WAN(
                                   inet=WanSettings('port1', 0, '203.0.113'),
                                   inet1=WanSettings('port1', 21, '100.64.21'),
                                   inet2=WanSettings('port1', 22, '100.64.22'),
        ...
        'FGT-C': FortiGate(offset=4, mgmt_ip='172.16.31.9/24',
                           wan=WAN(
        ...
        'FGT-C_sec': FortiGate(offset=5, mgmt_ip='172.16.31.15/24',
                               wan=WAN(
                                   inet=WanSettings('port1', 0, '192.0.2'),
                                   inet1=WanSettings('port1', 31, '100.64.31'),
                                   inet2=WanSettings('port1', 32, '100.64.32'),
        ...
        'FGT-D': FortiGate(offset=6, mgmt_ip='172.16.31.22/24',
                           wan=WAN(
        ...
        'FGT-D_sec': FortiGate(offset=7, mgmt_ip='172.16.31.23/24',
                               wan=WAN(
                                   inet=WanSettings('port1', 0, '100.64.40'),
                                   inet1=WanSettings('port1', 41, '100.64.41'),
                                   inet2=WanSettings('port1', 42, '100.64.42'),
        ...
        'ISFW-A': FortiGate(offset=8, mgmt_ip='172.16.31.19/24'),
        'Internet': Vyos(offset=9, mgmt_ip='172.16.31.251/24'),
        'MPLS': Vyos(offset=10, mgmt_ip='172.16.31.252/24'),
        'PC_A1': LXC(offset=11, mgmt_ip='172.16.31.3/24'),
        'PC_A2': LXC(offset=12, mgmt_ip='172.16.31.5/24'),
        'PC_B1': LXC(offset=13, mgmt_ip='172.16.31.4/24'),
        'PC_B2': LXC(offset=14, mgmt_ip='172.16.31.6/24'),
        'PC_C1': LXC(offset=15, mgmt_ip='172.16.31.10/24'),
        'PC_C2': LXC(offset=16, mgmt_ip='172.16.31.11/24'),
        'PC_D1': LXC(offset=17, mgmt_ip='172.16.31.16/24'),
        'PC_D2': LXC(offset=18, mgmt_ip='172.16.31.17/24'),
        'RTR-NAT_A': LXC(offset=19, mgmt_ip='172.16.31.7/24'),
    ...
    def __init__(self, request: WSGIRequest, poc_id: int, devices: dict):
        ...
        for device in self.devices.values():
            ...
            if ip == '0.0.0.0':  # fpoc-manager is running inside the FortiPoC
                ...
                device.ip = ipaddress.ip_interface(device.mgmt_ip).ip.compressed
