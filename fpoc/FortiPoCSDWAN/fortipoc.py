    ...
    devices = {
        'WEST-DC1': FortiGate(offset=0, model="FGT_VM64_KVM", password="nsefortinet",
                            ...
                            wan=WAN(
                                ...
                                inet1=Interface('port1', 11, '100.64.11', 'Internet_1'),
                                inet2=Interface('port1', 12, '100.64.12', 'Internet_2'),
                                ...
                                mpls1=Interface('port2', 14, '10.71.14', 'MPLS'),
        ...
        'WEST-DC2': FortiGate(offset=2, model="FGT_VM64_KVM", password="nsefortinet",
                            ...
                            wan=WAN(
                                ...
                                inet1=Interface('port1', 21, '100.64.21', 'Internet_1'),
                                inet2=Interface('port1', 22, '100.64.22', 'Internet_2'),
                                ...
                                # inet3_snat=Interface('port1', 230, '192.168.230'),
                                # inet3_dnat=Interface('port1', 231, '192.168.231'),
                                mpls1=Interface('port2', 24, '10.71.24', 'MPLS'),
        ...
        'EAST-DC': FortiGate(offset=3, model="FGT_VM64_KVM", password="nsefortinet",
                            ...
                            wan=WAN(
                                # inet=Interface('port1', 0, '203.0.113'),
                                inet1=Interface('port1', 121, '100.64.121', 'Internet_1'),
                                inet2=Interface('port1', 122, '100.64.122', 'Internet_2'),
                                ...
                                # inet3_snat=Interface('port1', 230, '192.168.230'),
                                # inet3_dnat=Interface('port1', 231, '192.168.231'),
                                mpls1=Interface('port2', 124, '10.71.124', 'MPLS'),
        ...
        'WEST-BR1': FortiGate(offset=4, model="FGT_VM64_KVM", password="nsefortinet",
                            ...
                            wan=WAN(
                                ...
                                # inet1=Interface('port1', 31, '100.64.31', 'Internet_1'),
                                # inet2=Interface('port1', 32, '100.64.32', 'Internet_2'),
                                ...
                                # inet3_snat=Interface('port1', 230, '192.168.230'),
                                # inet3_dnat=Interface('port1', 231, '192.168.231'),
                                mpls1=Interface('port2', 34, '10.71.34', 'MPLS'),
        ...
        'WEST-BR2': FortiGate(offset=6, model="FGT_VM64_KVM", password="nsefortinet",
                            ...
                            wan=WAN(
                                ...
                                # inet1=Interface('port1', 41, '100.64.41', 'Internet_1'),
                                # inet2=Interface('port1', 42, '100.64.42', 'Internet_2'),
                                ...
                                # inet3_snat=Interface('port1', 230, '192.168.230'),
                                # inet3_dnat=Interface('port1', 231, '192.168.231'),
                                mpls1=Interface('port2', 44, '10.71.44', 'MPLS'),
        ...
        'EAST-BR': FortiGate(offset=7, model="FGT_VM64_KVM", password="nsefortinet",
                            ...
                            wan=WAN(
                                ...
                                # inet1=Interface('port1', 141, '100.64.141', 'Internet_1'),
                                # inet2=Interface('port1', 142, '100.64.142', 'Internet_2'),
                                ...
                                # inet3_snat=Interface('port1', 230, '192.168.230'),
                                # inet3_dnat=Interface('port1', 231, '192.168.231'),
                                mpls1=Interface('port2', 144, '10.71.144', 'MPLS'),
